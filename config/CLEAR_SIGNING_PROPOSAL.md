...
This document accompanies [`config/clearSigningProposal.json`](./clearSigningProposal.json) — a generated proposal of ERC-7730 `display.formats` entries for every user-facing function in the LIFI Diamond.
