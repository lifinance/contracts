...
var omni_1 = __importStar(require("../config/omni"));
...
var DST_CHAIN = 'sokol'; // Sending chain
var destinationChainId = 77; // POA Sokol chain id
var amountIn = ethers_1.utils.parseUnits('0.05', 6);
var amountOut = ethers_1.utils.parseEther('2');
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var srcChainProvider1, srcChainProvider, wallet, walletAddress, dstChainProvider1, dstChainProvider, homeOmniBridge, lifi, l2Address, token, uniswap, path, to, deadline, swapData, lifiData, bridgeData, allowance, amount, wethOmniBridge, wethAddress, l2Token, lifiData, bridgeData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    srcChainProvider1 = new ethers_1.providers.JsonRpcProvider((0, network_1.node_url)(SRC_CHAIN));
                    srcChainProvider = new ethers_1.providers.FallbackProvider([srcChainProvider1]);
                    wallet = ethers_1.Wallet.fromMnemonic(process.env.MNEMONIC);
                    wallet = wallet.connect(srcChainProvider);
                    return [4 /*yield*/, wallet.getAddress()];
                case 1:
                    walletAddress = _a.sent();
                    dstChainProvider1 = new ethers_1.providers.JsonRpcProvider((0, network_1.node_url)(DST_CHAIN));
                    dstChainProvider = new ethers_1.providers.FallbackProvider([dstChainProvider1]);
                    homeOmniBridge = new ethers_1.Contract(omni_1.default[SRC_CHAIN].homeOmniBridge, omni_1.BRIDGED_TOKEN_ADDRESS_ABI, dstChainProvider);
                    lifi = typechain_1.OmniBridgeFacet__factory.connect(LIFI_ADDRESS, wallet);
                    return [4 /*yield*/, homeOmniBridge.bridgedTokenAddress(DAI_L1_ADDRESS)];
                case 2:
                    l2Address = _a.sent();
                ...
                case 3:
                    ...
                    bridgeData = {
                        ...
                        amount: amountOut,
                        receiver: walletAddress,
                        bridge: omni_1.default[SRC_CHAIN].foreignOmniBridge,
                    };
                ...
                return [4 /*yield*/, lifi.swapAndStartBridgeTokensViaOmniBridge(lifiData, [
                        {
                            sendingAssetId: USDT_TOKEN_ADDRESS,
                ...
                case 7:
                    ...
                    wethOmniBridge = new ethers_1.Contract(omni_1.default[SRC_CHAIN].wethOmniBridge, omni_1.WETH_ADDRESS_ABI, srcChainProvider);
                    return [4 /*yield*/, wethOmniBridge.WETH()];
                case 8:
                    wethAddress = _a.sent();
                    return [4 /*yield*/, homeOmniBridge.bridgedTokenAddress(wethAddress)
                        // LIFI Data
                    ];
                case 9:
                    l2Token = _a.sent();
                    ...
                    bridgeData = {
                        ...
                        amount: amount,
                        receiver: walletAddress,
                        bridge: omni_1.default[SRC_CHAIN].wethOmniBridge,
                    };
                    // Call LiFi smart contract to start the bridge process -- WITH SWAP
                    return [4 /*yield*/, lifi.startBridgeTokensViaOmniBridge(lifiData, bridgeData, {
                            gasLimit: '500000',
                            value: amount,
                        })];
                case 10:
