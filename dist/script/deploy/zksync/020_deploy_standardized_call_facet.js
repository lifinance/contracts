...
var func = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var deployments, getNamedAccounts, deploy, deployer, deployedFacet, accessManagerFacet, diamond, isVerified;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deploy('StandardizedCallFacet', {
                            from: deployer,
                            log: true,
                ...
                case 2:
                    ...
                    return [4 /*yield*/, hardhat_1.ethers.getContract('StandardizedCallFacet')];
                case 3:
                    accessManagerFacet = _a.sent();
                    return [4 /*yield*/, hardhat_1.ethers.getContract(_9999_utils_1.diamondContractName)];
                case 4:
                    diamond = _a.sent();
                    return [4 /*yield*/, (0, diamond_1.addOrReplaceFacets)([accessManagerFacet], diamond.address)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, (0, _9999_utils_1.verifyContract)(hre, 'StandardizedCallFacet', {
                            address: accessManagerFacet.address,
                        })];
                case 6:
                    isVerified = _a.sent();
                    return [4 /*yield*/, (0, _9999_utils_1.updateDeploymentLogs)('StandardizedCallFacet', deployedFacet, isVerified)];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
            }
