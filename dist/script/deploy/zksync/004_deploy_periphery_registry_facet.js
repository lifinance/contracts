...
var func = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var deployments, getNamedAccounts, deploy, deployer, deployedFacet, registryFacet, diamond, isVerified;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deploy('PeripheryRegistryFacet', {
                            from: deployer,
                            log: true,
                ...
                case 2:
                    ...
                    return [4 /*yield*/, hardhat_1.ethers.getContract('PeripheryRegistryFacet')];
                case 3:
                    registryFacet = _a.sent();
                    return [4 /*yield*/, hardhat_1.ethers.getContract(_9999_utils_1.diamondContractName)];
                case 4:
                    diamond = _a.sent();
                    return [4 /*yield*/, (0, diamond_1.addOrReplaceFacets)([registryFacet], diamond.address)];
                case 5:
                    _a.sent();
                ...
                case 6:
                    isVerified = _a.sent();
                    return [4 /*yield*/, (0, _9999_utils_1.updateDeploymentLogs)('PeripheryRegistryFacet', deployedFacet, isVerified)];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
            }
