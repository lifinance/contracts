...
| `108-vault-wrapper.md`        | Vault Wrapper subsystem constraints (standalone, not Diamond)    | ❌ On match | `src/VaultWrapper/**`, `test/solidity/VaultWrapper/**`, `script/deploy/facets/Deploy*VaultWrapper*.s.sol`     |
