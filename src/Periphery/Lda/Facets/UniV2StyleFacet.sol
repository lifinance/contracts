...
contract UniV2StyleFacet {
    ...
    function swapUniV2(
        ...
        (uint256 reserveIn, uint256 reserveOut) = direction == DIRECTION_TOKEN0_TO_TOKEN1
            ? (r0, r1)
            : (r1, r0);
        ...
        amountOut = (amountInWithFee * reserveOut) / (reserveIn * 1_000_000 + amountInWithFee);
        
        (uint256 amount0Out, uint256 amount1Out) = direction == DIRECTION_TOKEN0_TO_TOKEN1
            ? (uint256(0), amountOut)
            : (amountOut, uint256(0));
