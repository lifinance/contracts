...
import { UnAuthorized, InvalidCallData, DiamondIsPaused, InvalidConfig } from "lifi/Errors/GenericErrors.sol";
import { IDiamondLoupe } from "lifi/Interfaces/IDiamondLoupe.sol";
import { DiamondCutFacet } from "lifi/Facets/DiamondCutFacet.sol";

/// @title LDAEmergencyPauseFacet (Admin only)
...
contract LDAEmergencyPauseFacet {
    /// Events ///
