...
A detailed explanation on how to use the /quote endpoint and how to trigger the transaction can be found in the [LI.FI token transfer guide](https://apidocs.li.fi/reference/how-to-transfer-tokens).
