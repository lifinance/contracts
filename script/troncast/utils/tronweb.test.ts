...
describe('parseValue — TRX to SUN', () => {
  it.each([
    ...
    // Trailing zeros are not precision: this is a plain 1.5 TRX, and reading
    // its seven fraction digits as sub-SUN refused an amount TRX can express.
    ['1.5000000tron', '1500000'],
    ['0.10000000000tron', '100000'],
  ...
  it('refuses an amount finer than one SUN rather than rounding it away', () => {
    ...
    // A significant digit past the sixth place is still refused, however many
    // zeros trail it.
    expect(() => parseValue('1.00000010000tron')).toThrow(/finer than one SUN/)
  })
