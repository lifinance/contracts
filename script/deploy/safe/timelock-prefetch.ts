 ...
 * call with an entrypoint check would make it importable but is deliberately
 * not done there: should the check ever read falsy for that entry, the
 * scheduled executor exits 0 having executed nothing, and no observer can tell
