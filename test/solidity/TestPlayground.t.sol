...
contract TestPlayground is Test {
    ...
    function test_Ali_fullAmount() public {
    ...
    function test_Ali_testAmount() public {
        vm.startPrank(WALLET);
        ERC20 token = ERC20(AO_ETHER);
    ...
    function test_Ali_testAmounPlusOne() public {
        vm.startPrank(WALLET);
        ERC20 token = ERC20(AO_ETHER);
        ...
        Pac(PAC_FINANCE).withdrawERC20(O_ETHER, testAmount + 1, WALLET);
    }
}
