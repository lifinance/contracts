...
contract FusePoolZapTest is DSTest {
    ...
    address internal constant TRIBE_FUSE_POOL = 0x07cd53380FE9B2a5E64099591b498c73F0EfaA66;
    address internal constant FRAX3CRV = 0xd632f22692FaC7611d2AA1C0D552930D43CAEd3B;
    address internal constant FTOKEN = 0x2ec70d3Ff3FD7ac5c2a72AAA64A398b6CA7428A5;
    address internal constant FETHER = 0xe92a3db67e4b6AC86114149F522644b34264f858;
    ...
    function testCanZapIn() public {
        ...
        assertEq(ERC20(FTOKEN).balanceOf(DEPOSITOR), 5000 * 10**ERC20(FTOKEN).decimals());

        ERC20(FRAX3CRV).approve(address(zap), amount);
        vm.expectRevert(abi.encodeWithSelector(FusePoolZap.InvalidPoolAddress.selector, address(0xb33f)));
