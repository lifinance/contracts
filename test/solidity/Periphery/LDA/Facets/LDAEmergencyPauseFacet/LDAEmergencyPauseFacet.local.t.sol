...
contract LDAEmergencyPauseFacetLOCALTest is TestBase {
    // EVENTS
    ...
    // STORAGE
    LDAEmergencyPauseFacet internal emergencyPauseFacet;
    ...
    function setUp() public override {
        ...
        emergencyPauseFacet = LDAEmergencyPauseFacet(
    ...
    function testRevert_WhenPauserWalletIsZeroAddress() public {
        ...
        new LDAEmergencyPauseFacet(address(0));
    }
    ...
    function test_PauserWalletCanPauseDiamond() public {
        ...
        LDADiamondLoupeFacet(address(diamond)).facets();
    }
    ...
    function test_DiamondOwnerCanUnpauseDiamondWithEmptyBlacklist() public {
        ...
        IDiamondLoupe.Facet[] memory allFacets = LDADiamondLoupeFacet(
            address(diamond)
        ).facets();
        ...
        // make sure diamond works normal again and has all facets reinstated
        allFacets = LDADiamondLoupeFacet(address(diamond)).facets();
    ...
    function test_CanUnpauseDiamondWithSingleBlacklist() public {
        ...
        LDAOwnershipFacet(address(diamond)).owner();
    }
    ...
    function test_CanUnpauseDiamondWithMultiBlacklist() public {
        ...
        vm.expectRevert(FunctionDoesNotExist.selector);
        LDAPeripheryRegistryFacet(address(diamond)).getPeripheryContract(
            "Executor"
        );
    }
    ...
    function test_DiamondOwnerCanRemoveFacetAndUnpauseDiamond() public {
        ...
        address facetAddress = LDADiamondLoupeFacet(address(diamond))
            .facetAddress(
                LDAPeripheryRegistryFacet(address(diamond))
        ...
        assertTrue(
            LDADiamondLoupeFacet(address(diamond)).facetAddress(
                LDAPeripheryRegistryFacet(address(diamond))
                    .registerPeripheryContract
                    .selector
            ) == address(0)
    ...
    function test_WillRevertWhenTryingToRemoveDiamondCutFacet() public {
        ...
        address diamondCutAddress = LDADiamondLoupeFacet(address(diamond))
            .facetAddress(
                LDADiamondCutFacet(address(diamond)).diamondCut.selector
            );
    ...
    function test_WillRevertWhenTryingToRemoveEmergencyPauseFacet() public {
        ...
        address emergencyPauseAddress = LDADiamondLoupeFacet(address(diamond))
            .facetAddress(
                LDAEmergencyPauseFacet(payable(address(diamond)))
                    .pauseDiamond
                    .selector
            );
    ...
    function test_HowManyFacetsCanWePauseMax() public {
        ...
        //
        IDiamondLoupe.Facet[] memory facets = LDADiamondLoupeFacet(
            address(diamond)
        ).facets();
