...
contract StargateFacetV2Test is TestBaseFacet {
    ...
    //     console.log(
    //         "balance USDC: ",
    //         usdc.balanceOf(address(stargateFacetV2))
    //     );
    //     console.log(
    //         "balance WETH: ",
    //         weth.balanceOf(address(stargateFacetV2))
    //     );
    //     console.log("balance DAI: ", dai.balanceOf(address(stargateFacetV2)));
    //     console.log("balance native: ", address(stargateFacetV2).balance);
    ...
    //     // bridgeData.minAmount = amountOut - 100;
