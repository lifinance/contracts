...
contract CBridgeAndFeeCollectionTest is DSTest, DiamondTest {
    ...
    function setUp() public {
        ...
        functionSelectors[0] = cBridge.startBridgeTokensViaCelerIM.selector;
    ...
    function testCanCollectTokenFeesAndBridgeTokens() public {
        ...
        CelerIMFacet.CelerIMData memory data = CelerIMFacet.CelerIMData({
            maxSlippage: 5000,
            nonce: 1,
        ...
        cBridge.swapAndStartBridgeTokensViaCelerIM(bridgeData, swapData, data);
        vm.stopPrank();
    ...
    function testCanCollectNativeFeesAndBridgeTokens() public {
        ...
        cBridge.swapAndStartBridgeTokensViaCelerIM{
    ...
    function testCanSwapCollectNativeFeesAndBridgeTokens() public {
        ...
        cBridge.swapAndStartBridgeTokensViaCelerIM{ value: amountIn }(
            bridgeData,
            swapData,
            data
        );
